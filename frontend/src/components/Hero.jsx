      ...
      <div className="container hero__inner">
        ...
        <div className="hero__texto">
          ...
          <h1 className="hero__titulo">
            <span className="hero__titulo-topo">
              Advocacia
            </span>
          ...
          <p className="hero__desc">
            Dra. Mylenna Montezano atua há mais de 7 anos em Direito de
            Família e Sucessões, com formação em mediação pela Polícia Civil
            do RS unindo técnica jurídica e escuta atenta em cada caso.
          </p>
