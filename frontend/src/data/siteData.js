...
export const advogada = {
  ...
  whatsappLink: 'https://wa.me/5551999999999',
...
export const valores = [
  { icon: '🤝', titulo: 'Humanidade',         desc: 'Atendimento acolhedor, sempre com empatia e total comprometimento.' },
  { icon: '🔍', titulo: 'Precisão',            desc: 'Análise cuidadosa de cada detalhe para a melhor estratégia jurídica.' },
  { icon: '🔒', titulo: 'Confidencialidade',   desc: 'Sigilo absoluto em todas as etapas do seu atendimento.' },
]
