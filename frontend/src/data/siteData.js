...
export const formacao = [
  { icon: 'graduation', titulo: 'Faculdade de Desenvolvimento do Rio Grande do Sul', desc: 'Formação em Direito' },
...
export const areasAtuacao = [
  ...
  {
    icon: 'users', titulo: 'Guarda e Alimentos',
  ...
  {
    icon: 'baby', titulo: 'Filiação, Adoção e Tutela',
  ...
  {
    icon: 'alert', titulo: 'Violência Doméstica',
  ...
  {
    icon: 'scale', titulo: 'Mediação Familiar',
  ...
  {
    icon: 'file', titulo: 'Inventário e Partilha',
